...
var appServices = angular.module('gestionepazienti.services', [  ]);

appServices.value('version', '1.10');
...
app.factory('toastService',function(){
	var toast = null;
		return {	
			...
			setToast: function(type, message, noTranslate){
				toast = {type: type, message: message, noTranslate: noTranslate};
			},	
			getToast: function(){
				return toast;
			}
