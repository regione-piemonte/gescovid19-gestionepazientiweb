...
public interface BaseAreaMapper {
	 ...
	 * @mbg.generated
	 */
	@Insert({ "insert into area (id_area, id_struttura, ", "id_d_area, nome, responsabile, ",
			"riferimento, stato_validita)", "values (#{idArea,jdbcType=INTEGER}, #{idStruttura,jdbcType=VARCHAR}, ",
			"#{idDArea,jdbcType=VARCHAR}, #{nome,jdbcType=VARCHAR}, #{responsabile,jdbcType=VARCHAR}, ",
