package it.csi.gestionepazienti.gestionepazientiweb.mapper.notifica.generated;
...
public interface NotificaMapper {
	 ...
	 * @mbg.generated
	 */
	@Insert({ "insert into notifica (not_id, not_data_notifica, ", "not_data_presa_visione, not_testo_request, ",
			"not_testo_response, id_soggetto, ", "cf_utente_richiesta, cf_utente_presa_vis, ",
			"cf_utente_dest, id_ente, ", "id_struttura, priorita_id, ", "not_tipo_id, not_ev_id, ",
			"not_az_id, not_ut_tipo_id, ", "utente_operazione, data_creazione, ", "data_modifica, data_cancellazione, ",
			"not_ut_tipo_id_dest)", "values (nextval('notifica_not_id_seq'), #{notDataNotifica,jdbcType=TIMESTAMP}, ",
			"#{notDataPresaVisione,jdbcType=TIMESTAMP}, #{notTestoRequest,jdbcType=VARCHAR}, ",
			"#{notTestoResponse,jdbcType=VARCHAR}, #{idSoggetto,jdbcType=INTEGER}, ",
			"#{cfUtenteRichiesta,jdbcType=VARCHAR}, #{cfUtentePresaVis,jdbcType=VARCHAR}, ",
			"#{cfUtenteDest,jdbcType=VARCHAR}, #{idEnte,jdbcType=INTEGER}, ",
			"#{idStruttura,jdbcType=VARCHAR}, #{prioritaId,jdbcType=INTEGER}, ",
			"#{notTipoId,jdbcType=INTEGER}, #{notEvId,jdbcType=INTEGER}, ",
			"#{notAzId,jdbcType=INTEGER}, #{notUtTipoId,jdbcType=INTEGER}, ",
			...
			"#{notUtTipoIdDest,jdbcType=INTEGER})" })
