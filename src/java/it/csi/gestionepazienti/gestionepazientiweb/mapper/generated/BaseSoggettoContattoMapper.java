...
public interface BaseSoggettoContattoMapper {
	...
	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table r_soggetto_contatti
	 * @mbg.generated
	 */
	@Delete({ "delete from r_soggetto_contatti",
	 ...
	 * @mbg.generated
	 * 
	 * id_soggetto_contatti,
	 * #{idSoggettoContatti,jdbcType=INTEGER},
	 */
	@Insert({ "insert into r_soggetto_contatti (id_soggetto_da, ",
			"id_soggetto_a, note_contatto, ", "id_decorso, contatto_tipo_id, ", "validita_inizio, validita_fine, ",
			"utente_operazione, data_creazione, ", "data_modifca, data_cancellazione)",
			"values (#{idSoggettoDa,jdbcType=BIGINT}, ",
	...
	@Options(useGeneratedKeys = true, keyProperty = "idSoggettoContatti")
	 ...
	 * @mbg.generated
	 */
	@Select({ "select", "id_soggetto_contatti, id_soggetto_da, id_soggetto_a, note_contatto, id_decorso, ",
			"contatto_tipo_id, validita_inizio, validita_fine, utente_operazione, data_creazione, ",
			"data_modifca, data_cancellazione", "from r_soggetto_contatti",
			"where id_soggetto_contatti = #{idSoggettoContatti,jdbcType=INTEGER}" })
	@Results({
	 ...
	 * @mbg.generated
	 */
	@Update({ "update r_soggetto_contatti", "set id_soggetto_da = #{idSoggettoDa,jdbcType=BIGINT},",
			"id_soggetto_a = #{idSoggettoA,jdbcType=BIGINT},", "note_contatto = #{noteContatto,jdbcType=VARCHAR},",
			"id_decorso = #{idDecorso,jdbcType=BIGINT},", "contatto_tipo_id = #{contattoTipoId,jdbcType=BIGINT},",
