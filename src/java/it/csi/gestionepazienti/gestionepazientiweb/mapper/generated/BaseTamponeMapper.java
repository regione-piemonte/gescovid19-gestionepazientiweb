...
public interface BaseTamponeMapper {
     ...
     * This method corresponds to the database table tampone
     *
     * @mbg.generated
     */
    @Delete({
     ...
     */
    @Insert({
        "insert into tampone (id_soggetto, id_laboratorio, ",
        "criterio_epidemiologico_covid19, id_test_covid, ",
        "data_test_str, id_ris_tamp, ",
        "tampone_autorizzato, data_inserimento_richiesta, ",
        "data_ultima_modifica, utente_ultima_modifica, ",
        "data_test, medico_richiedente, ",
        "contatto_richiedente, tampone_motivo_id)",
    ...
    @Select({
        "select",
        "id_tampone, id_soggetto, id_laboratorio, criterio_epidemiologico_covid19, id_test_covid, ",
    ...
    @Update({
        ...
        "set id_soggetto = #{idSoggetto,jdbcType=BIGINT},",
          ...
          "data_test_str = #{dataTestStr,jdbcType=VARCHAR},",
          ...
          "tampone_motivo_id = #{tamponeMotivoId,jdbcType=INTEGER}",
        "where id_tampone = #{idTampone,jdbcType=BIGINT}"
    })
