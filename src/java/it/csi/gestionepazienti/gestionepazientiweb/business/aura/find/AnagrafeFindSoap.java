...
public interface AnagrafeFindSoap {
     ...
     * @return
     *     returns it.csi.gestionepazienti.gestionepazientiweb.business.aura.DatiAnagraficiMsg
     */
    ...
    @RequestWrapper(localName = "FindProfiliAnagrafici", targetNamespace = "http://AnagrafeFind.central.services.auraws.aura.csi.it", className = "it.csi.gestionepazienti.gestionepazientiweb.business.aura.FindProfiliAnagrafici")
    @ResponseWrapper(localName = "FindProfiliAnagraficiResponse", targetNamespace = "http://AnagrafeFind.central.services.auraws.aura.csi.it", className = "it.csi.gestionepazienti.gestionepazientiweb.business.aura.FindProfiliAnagraficiResponse")
