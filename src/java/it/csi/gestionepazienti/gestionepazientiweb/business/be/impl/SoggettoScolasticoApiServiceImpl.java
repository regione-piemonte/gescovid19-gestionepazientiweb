...
import it.csi.gestionepazienti.gestionepazientiweb.business.be.SoggettoScolasticoApi;
...
public class SoggettoScolasticoApiServiceImpl extends AbstractSoggettoApiServiceImpl implements SoggettoScolasticoApi {
	...
	public Response getSoggettoScolasticoByIdSoggetto(Long id, SecurityContext securityContext, HttpHeaders httpHeaders,
		...
		try {
			...
			SoggettoForPersonaleScolastico soggetto = soggettoPersonaleScolasticoMapper.selectSoggettoPersonaleScolasticoByIdSoggetto(id);
			if (soggetto==null)
			{
			...
			insertAudit("select", "selectSoggettoPersonaleScolasticoByIdSoggetto ID", "select("+soggetto.getIdSoggetto()+")", currentUser.getCfUtente(), null, req);
	...
	public Response updateSoggettoScolastico(Long idSoggetto, SoggettoForPersonaleScolastico soggettoScolastico, SecurityContext securityContext,
		...
		try {
			...
			currentUser.getElencoEnte();
			
			SoggettoForPersonaleScolastico soggetto = soggettoPersonaleScolasticoMapper.selectSoggettoPersonaleScolasticoByIdSoggetto(idSoggetto);
	...
	private Referto insertRefertoForSoggetto(SoggettoForPersonaleScolastico soggettoScolastico,
		...
		r.setCodCl("gestpazienti.siero.scuola");
