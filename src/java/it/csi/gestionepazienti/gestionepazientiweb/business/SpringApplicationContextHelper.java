...
import it.csi.gestionepazienti.gestionepazientiweb.util.AppServletContextListener;
...
public class SpringApplicationContextHelper implements ApplicationContextAware {
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		...
		System.out.println("[SpringApplicationContextHelper::registerRestEasyController] - totale beans " + appContext.getBeanDefinitionCount());
		if(appContext.getBeanDefinitionNames()!=null)
			for (String beanName : appContext.getBeanDefinitionNames()) {
				System.out.println("[SpringApplicationContextHelper::registerRestEasyController] - beanName " + beanName);
			}
	}
	...
	public static void registerRestEasyController(Object service) {
		System.out.println("[SpringApplicationContextHelper::registerRestEasyController] - " + service.getClass().getSimpleName());
